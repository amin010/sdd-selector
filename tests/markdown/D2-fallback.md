...
Confidence: low · score -0.6638861538461538 · margin 0.28890807692307696
...
- Axis contributions:
  - brownfield: demand 0.17, coverage 0.47, unmet 0.10
- Enforcement:
...
## Runner-up
GSD Core — Acceptability 19% vs 26% for OpenSpec.
...
### Delta-only specs (included in base) — 46% inclusion
Source: OpenSpec
...
### Change archive (included in base) — 30% inclusion
Source: OpenSpec
