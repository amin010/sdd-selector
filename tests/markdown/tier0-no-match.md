...
## Cautions
### C20 — medium
The recommended framework does not document the agent runtimes you selected. Runtime match is a soft preference: the framework stayed in consideration and was score-penalized instead of being deleted.
Mitigation: If you are unsure which runtimes you use, choose Unsure / any. Confirm the recommended framework actually supports your agent before adopting it.
Source: QC experiment; q20 danger quadrant
