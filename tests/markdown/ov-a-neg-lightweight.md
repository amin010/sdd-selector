...
Confidence: low · score -0.7307542307692307 · margin 0.16188076923076933
...
- Axis contributions:
  - auditTrail: demand 0.15, coverage 0.15, unmet 0.12
- Enforcement:
...
## Runner-up
GSD Core — Acceptability 20% vs 23% for OpenSpec.

## Practice overlays
### Low-ceremony fast path (included in base) — 45% inclusion
Source: OpenSpec
