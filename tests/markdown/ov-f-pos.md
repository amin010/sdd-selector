...
Source: native CI
SOX or zero-tolerance with tests-or-nothing in CI has no fail-closed gate among these frameworks. CI is the gate.
Enforcement: Hard gate — failing CI build.
Triggered by: q8_compliance = sox_tier1; q21_ci_maturity = none
